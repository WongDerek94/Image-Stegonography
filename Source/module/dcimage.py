"""
Wrapper class of the python Pillow module.  
Includes core functionality such as loading images, providing next pixels in line,
  editing pixels at a specific poitn or returning properties of an image.
"""
